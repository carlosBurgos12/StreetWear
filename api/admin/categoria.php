...
require_once('../../api/data/categoria_data.php');
        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    ...
                    !$categoria->setImagen($_FILES['imagenCategoriaCrear'])
                ) {
                    ...
                    $result['fileStatus'] = Validator::saveFile($_FILES['imagenCategoriaCrear'], $categoria::RUTA_IMAGEN);
                } else {
